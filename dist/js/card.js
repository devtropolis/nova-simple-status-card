...
Nova.booting(function (Vue, router) {
    Vue.component('nova-simple-status-card', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        fetchEventsList: function fetchEventsList() {
            var self = this;
            axios.get(this.card.url).then(function (response) {
...
var render = function() {
  ...
  return _c("card", { staticClass: "flex flex-col", class: _vm.bgStatus }, [
    _c("div", [
      _c("div", { staticClass: "px-3 py-3" }, [
        _c("div", { staticClass: "position-absolute float-right" }, [
          _vm.card.icon
            ? _c("img", {
                attrs: { width: "40px", height: "40px", src: _vm.card.icon }
              })
            : _vm._e()
        ]),
        _vm._v(" "),
        _c("h3", { staticClass: "mb-1 text-90 font-bold text-lg text-white" }, [
